...
{
	int         ret       = MSP_SUCCESS;
	const char *lgi_param = "appid = 1b8f255d,work_dir = .";
	const char *ssb_param = "ivw_threshold=0:1450,sst=wakeup,ivw_res_path =fo|../awaken/bin/msc/res/ivw/wakeupresource.jet";
